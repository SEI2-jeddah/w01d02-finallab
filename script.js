...
var tasteTest = ["perfectly made", "delicious", "burned", "too salty"]

console.log("1. main dish 2. appetizer 3.dessert")
let meal = prompt("Hello " + input + " Choose number of the meal you would like to cook?")
console.log(meal)
...
if (meal == 1) {//main dish
    ...
    if (dish == 1) { // burger
        ...
        let dishProtien = prompt("Choose number of the dish protien you like to cook?")
        ...
        if (dishProtien == 1) {//chicken
            ...
            if (score >= 2) {//score
                ...
                console.log("Your meal was " + tasteTest[Math.floor(Math.random() * 2)])
            } else {
            ...
            if (score >= 2) {//score
                ...
                console.log("sorry you've lost :(")
                console.log("Your meal was " + tasteTest[Math.floor(Math.random() * 2) + 2]) 
            }
        }   
